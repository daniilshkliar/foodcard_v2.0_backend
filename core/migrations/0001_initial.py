    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordinates', django_better_admin_arrayfield.models.fields.ArrayField(base_field=models.DecimalField(decimal_places=6, max_digits=9), size=2)),
                ('floor', models.PositiveSmallIntegerField(blank=True, default=1)),
                ('timezone', models.CharField(blank=True, max_length=50, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('opening_hours', django_better_admin_arrayfield.models.fields.ArrayField(base_field=django_better_admin_arrayfield.models.fields.ArrayField(base_field=models.DateTimeField(null=True), null=True, size=2), blank=True, null=True, size=7)),
                ('instagram', models.URLField(blank=True, null=True)),
                ('website', models.URLField(blank=True, null=True)),
                ('main_photo', models.URLField(blank=True, null=True)),
                ('is_active', models.BooleanField(default=False)),
                ('additional_categories', models.ManyToManyField(blank=True, to='core.Category')),
                ('additional_cuisines', models.ManyToManyField(blank=True, to='core.Cuisine')),
                ('additional_services', models.ManyToManyField(blank=True, to='core.AdditionalService')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.country')),
                ('main_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='main_category', to='core.category')),
                ('main_cuisine', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='main_cuisine', to='core.cuisine')),
            ],
        ),
        migrations.CreateModel(
            name='Table',
            fields=[
                ...
                ('min_guests', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1)])),
                ('floor', models.PositiveSmallIntegerField(blank=True, default=1, validators=[django.core.validators.MinValueValidator(1)])),
                ...
                ('deposit', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default_currency='USD', max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='place_images')),
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.place')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='menu_images')),
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.place')),
            ],
        ),
        migrations.CreateModel(
