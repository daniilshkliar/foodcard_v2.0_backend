    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('csn', 'csn'), ('sal', 'sal'), ('hap', 'hap'), ('fme', 'fme'), ('shd', 'shd'), ('sdi', 'sdi'), ('sou', 'sou'), ('pas', 'pas'), ('piz', 'piz'), ('des', 'des'), ('hdr', 'hdr'), ('cdj', 'cdj'), ('add', 'add')], max_length=3)),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='BYN', max_digits=10)),
                ...
                ('carbohydrates', models.PositiveSmallIntegerField(blank=True, null=True)),
